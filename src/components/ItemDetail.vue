<template>
	<v-card>
		...
		<v-container style="margin-top:-20px; padding-right:5%">
			<v-row dense>
				<v-col cols="12" md="8">
					<v-carousel
						hide-delimiters
				...
				<v-col cols="12" md="4">
					<v-row dense>
						...
						<v-col cols="12">
							<v-text-field label="Pick up address" prepend-icon="place" readonly :value="detail.address"></v-text-field>
						</v-col>
						<v-col cols="12">
							<v-textarea
								outlined
		...
		<v-card-actions>
			<v-btn class="ma-2 white--text blue darken-1" @click="openMessageDialog">
				Message
